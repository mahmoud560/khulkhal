...
<link rel=stylesheet href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
 <link rel=stylesheet href="css/mains.css">
  <link rel= stylesheet href="css/shshshs.css">
 ...
 <script type="text/javascript">
    ...
    <div class="div-btn row col-12">
        ...
        <span class="side-check-btn text-center col-10 order-2"><a href="checkout.php" class="text-center side-check-btn-a">Checkout</a></span>
    </div>
     </div>
        </div>
    </div>
    ...
    <div>
        ...
        <i class="fas fa-shopping-bag" id="Show-cart"><div class="cartLength">1</div></i>
    </div>
              
               <img class="img" src="images/khulkhal%20logo.png">
        <div class="menu-wrap">
                 ...
                 <div>
                    <div>
                       <ul>
                        ...
                        <a class="inst-icon" href="https://www.instagram.com/khulkhal_jewelry/" target="blank"> <i class="fab fa-instagram"> </i> </a>
                    </div>
                </div>
            </div>
        </div>
