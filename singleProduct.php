...
<section class="testSingleProd">
    <div class="testProdImg">
        <div>
            <span class="testProdDivsSlider">
                <div></div><i class="fas fa-ellipsis-h"></i>
                <div></div>
            </span>
        </div>
    </div>
    <div class="testProdInfo">
        <div>
            <h1 class="text-center">Product Name</h1>
            <p>GOLD PLATED AND SILVER 925</p>
            <h2>500<span>EGP</span></h2>
...
<script src="https://cdn.jsdelivr.net/npm/contentful@latest/dist/contentful.browser.min.js"></script>
    <script src="js/jsss.js" async></script> 
